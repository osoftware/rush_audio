                ...
                ElevatedButton.icon(
                  onPressed: () async {
                    if (_playing) {
                      ...
                      await _sequencer?.playAsset(
                        midiAsset: 'assets/toccata_and_fugue_in_d_minor.mid',
                        playLoop: true,
                      );
                    }
